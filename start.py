    ...
    if FORCE_SUB:
        try:
          ...
          if str(user.status) == "ChatMemberStatus.BANNED":
            ...
            await message.reply_photo(photo="https://graph.org/file/e68c680caaddbb7b5d652-e8bc03767992a634e4.jpg",caption=caption, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{link}")]]))
            return 1
...
async def plan(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/ITSMUNNABHAIYA")],
        ]
    )
